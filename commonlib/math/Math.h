...
public:
	...
	{
		return Vector3(Math::NegInfinity, Math::NegInfinity, Math::NegInfinity);
	}
	//static const Vector3 Zero;
	//static const Vector3 One;
	//static const Vector3 UnitX;
...
public:
	...
	// static変数だとグローバルの変数を初期化する際に初期化順によって正しくせ設定されない可能性があるので関数化しておく.
	//static const Quaternion Identity;
